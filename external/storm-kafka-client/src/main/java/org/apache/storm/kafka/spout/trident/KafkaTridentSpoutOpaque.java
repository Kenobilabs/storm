...
public class KafkaTridentSpoutOpaque<K, V> implements
    IOpaquePartitionedTridentSpout<List<TopicPartition>, KafkaTridentSpoutTopicPartition, KafkaTridentSpoutBatchMetadata<K, V>> {
  ...
  public Emitter<List<TopicPartition>, KafkaTridentSpoutTopicPartition, KafkaTridentSpoutBatchMetadata<K, V>> getEmitter(
    ...
    if (conf != null && conf.containsKey(KAFKACONSTANTS.STATSD)
      ...
      context.setTaskData(KAFKACONSTANTS.STATSD, "KafkaTridentSpoutOpaque");
      return new KafkaTridentSpoutEmitterWithStatsD(conf, kafkaManager, context);
    } else {
